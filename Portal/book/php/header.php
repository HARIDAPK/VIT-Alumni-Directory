...
<h3 class="navbar-cls-top navbar-brand " style="background: orangered ;color: white;font-weight: 800;">VIT Alumni Directory</h3>
</div>
...
<li>
<a href="proctee.php">
<i class="fa fa-user fa-lg"></i> Proctee
</a>
</li>
...
<a href="#"><i class="fa fa-user fa-lg"></i> Student Info <span class="arrow"></span></a>
</li>
<ul class="sub-menu collapse" id="stuInfo">
<li><a href="show.php">Academic records</a></li>
<li><a href="activity.php">Extracurricular</a></li>
<li><a href="find.php">Time table</a></li>
</ul>
<li>
<a href="alumini.php">

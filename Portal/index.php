...
<center>
<img src="bg.jpeg" style="width:50%">
<a href="book/login.php"style="color:white"><p class="btn btn-info btn-sm button1"> FACULTY LOGIN</p></a><br>
<a href="book/stu_login.php" style="color:white"><p class="btn btn-success btn-sm button2">  STUDENT LOGIN</p></a>
</center>
</form>
</div>
</body>
